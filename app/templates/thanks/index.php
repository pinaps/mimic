...
<div class="container-fluid">
   ...
   <div class="row">
     ...
     <div class="col-md-12">
        ...
        <img src="<?= $this->assetUrl("img/peanuts2.jpg")?>"class="mimic img-responsive" alt="BD Peanuts">
        ...
        <p>Suivons le conseil de Bernard Haller, qu'on retrouvera ici ou là sur ce site : « N’ouvrez plus la bouche. Parlez sans dire un mot »</p>
